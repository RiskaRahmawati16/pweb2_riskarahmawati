        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-6"><span class="text-muted fw-light"></span> Edit Data</h4> 
              ...
              @section('konten')
              {{-- <div class="card"> --}}
                <form action="/tabel/{{$data->id}}" method="POST">
                    @csrf
                    @method('put')
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="nama_barang" class="form-control" id="nama_barang" value="{{$data->nama_barang}}">
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="satuan" class="form-control" id="satuan" value="{{$data->satuan}}">
                    </div>
